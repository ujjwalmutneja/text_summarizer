...
# @app.route('/')
# #: This is a route decorator that maps the URL path '/' to the index function. This means that when a user accesses the root URL (e.g., http://localhost:5000/), the index function will be called
